...
angular.module('highcharts-ng', [])
  .factory('highchartsNGUtils', function () {
    ...
    var getMergedOptions = function (scope, element, config) {
      ...
      if (config.chart.plotBackgroundColor) {
        mergedOptions.chart.plotBackgroundColor = config.chart.plotBackgroundColor;
      }

      if (config.chart.backgroundColor) {
        mergedOptions.chart.backgroundColor = config.chart.backgroundColor;
      }
