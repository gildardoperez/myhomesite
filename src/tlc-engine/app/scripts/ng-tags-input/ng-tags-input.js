    ...
    function TagList(options, events, onTagAdding, onTagRemoving) {
        ...
        self.add = function(tag) {
            ...
            if(self.items.length >= 1){
                $('#menu4').addClass('menu4_class');
                $('#'+document.activeElement.parentNode.id).addClass('school_class');
                options.placeholder = "";
            }
            return tag;
        };
        ...
        self.remove = function(index) {
            ...
            if (onTagRemoving({ $tag: tag }))  {
                ...
                if(self.items.length <= 1){
                 $('#'+document.activeElement.parentNode.id).removeClass('school_class');
                $('#menu4').removeClass('menu4_class');
                var school_length = $('#subdiv .school_class').length,
                    search_length = $('#search .school_class').length;
            ...
            scope.eventHandlers = {
                ...
                host: {
                    click: function() {
                        ...
                        input[0].focus();
                        scope.eventHandlers.input.focus();  
                    }
                }
            };
    ...
    return {
        ...
        link: function(scope, element, attrs, tagsInputCtrl) {
            ...
            scope.$removeTag = function() {
                ...
                if($("#school_district_control tags-input div div div ul li").length==1){
                  $("#school_district_control tags-input div div ul:first").css('height','26px');
                }
              if($("#propertystyle div div div ul li").length==1){
                $("#propertystyle div div ul:first").css('height','26px');
              }
            };
    ...
    return {
        ...
        link: function(scope, element, attrs, tagsInputCtrl) {
            ...
            scope.addSuggestionByIndex = function(index) {
                ...
                scope.addSuggestion();
                //$("#school_district_control tags-input div div ul").show();
                //$("#school_district_control tags-input div div div").show();
              //$("#school_district_control tags-input div div div ul").css('padding','0px 0px 15px 0px');
            };
...
tagsInput.run(["$templateCache", function($templateCache) {
    $templateCache.put('ngTagsInput/tags-input.html',
      "<div class=\"host\" tabindex=\"-1\" ng-click=\"eventHandlers.host.click()\" ti-transclude-append=\"\"><div class=\"tags\" ng-class=\"{focused: hasFocus}\" pscrollbar='{wheelSpeed:0.1}'><ul class=\"tag-list\"><li class=\"tag-item\" ng-repeat=\"tag in tagList.items track by track(tag)\" ng-class=\"{ selected: tag == tagList.selected }\"><ti-tag-item data=\"tag\"></ti-tag-item></li><input class=\"input\" autocomplete=\"off\" ng-model=\"newTag.text\" ng-change=\"eventHandlers.input.change(newTag.text)\" ng-keydown=\"eventHandlers.input.keydown($event)\" ng-blur=\"eventHandlers.input.blur($event)\" ng-paste=\"eventHandlers.input.paste($event)\" ng-trim=\"false\" ng-class=\"{'invalid-tag': newTag.invalid}\" ng-disabled=\"disabled\" ti-bind-attrs=\"{type: options.type, placeholder: options.placeholder, tabindex: options.tabindex, spellcheck: options.spellcheck}\" ti-autosize=\"\"></ul></div></div>"
  );
  ...
  $templateCache.put('ngTagsInput/auto-complete.html',
    "<div class=\"autocomplete\" ng-if=\"suggestionList.visible\" pscrollbar='{minScrollbarLength:20}'><ul class=\"suggestion-list\"><li class=\"suggestion-item\" ng-repeat=\"item in suggestionList.items track by track(item)\" ng-class=\"{selected: item == suggestionList.selected}\" ng-click=\"addSuggestionByIndex($index)\" ng-mouseenter=\"suggestionList.select($index)\"><ti-autocomplete-match data=\"item\"></ti-autocomplete-match></li></ul></div>"
  );
